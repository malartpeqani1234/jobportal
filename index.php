                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                <select class="form-select border-0">
                                    <?php
                                    $rezCategory = mysqli_query($conn, "select id, `category-name`, `category-image`, `category-description` from categories") or die("Query failed: " . mysqli_error($conn));
                                    while (list($id, $categoryname) = mysqli_fetch_array($rezCategory)) {
