                ...
                <div class="col-md-14">
                    <div class="card ">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title">Manage Jovs</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive ps">
                                <table class="table tablesorter table-hover" id="">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($conn, "SELECT `id`, `job-name`, `job-description`, `schedule`, `email` FROM jobs") or die("query 2 incorrect.......");

                                        while (list($id, $jobname, $jobdescription, $schedule, $email) = mysqli_fetch_array($result)) {
                                            echo "<tr>
                                            <td>$id</td>
                                            <td>$jobname</td>
