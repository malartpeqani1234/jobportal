            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="../admin/users/view.php">View</a>
                        <a class="nav-link" href="../admin/users/add.php">Add</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="../admin/categories/view.php">View</a>
                        <a class="nav-link" href="../admin/categories/add.php">Add</a>
                    </nav>
                </div>
