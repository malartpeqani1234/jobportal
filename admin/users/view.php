                        ...
                        <div class="card-body">
                            <div class="table-responsive ps">
                                <table class="table tablesorter table-hover" id="">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($conn, "select id, `full-name`, email, password, usertype from users") or die("query 2 incorrect.......");

                                        while (list($id, $fullname, $email, $password, $usertype) =
