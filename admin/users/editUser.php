...
$user_id = $_REQUEST['id'];
$result = mysqli_query($conn, "SELECT `id`, `full-name`, `email`, `password`, `usertype` FROM `users` WHERE id='$user_id'") or die(mysqli_error($conn));
$row = mysqli_fetch_array($result);
// print_r(mysqli_fetch_assoc($result));

list($id, $fullname, $email, $password) = mysqli_fetch_array($result);
...
if (isset($_POST['updateUser'])) {
    ...
    $updateQuery = "UPDATE `users` SET `id`='$user_id', `full-name`='$fullname',`email`='$email,`password`='$password' WHERE id='$user_id'";
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="fullname" name="fullname" class="form-control" value="<?php echo $row['full-name'] ?>">
                                </div>
                            </div>
